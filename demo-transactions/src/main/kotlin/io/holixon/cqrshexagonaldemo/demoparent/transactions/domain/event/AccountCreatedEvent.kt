package io.holixon.cqrshexagonaldemo.demoparent.transactions.domain.event
...
data class AccountCreatedEvent(val customerNumber: CustomerNumber, val iban: Iban)
